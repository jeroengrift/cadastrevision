...
- The related benchmark dataset (imagery and cadastral reference) is available at: https://phys-techsciences.datastations.nl/dataset.xhtml?persistentId=doi:10.17026/PT/OS3OWX
